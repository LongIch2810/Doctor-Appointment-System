...
export class SeedData1749460808643 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    //Thêm dữ liệu về chuyên khoa
    await queryRunner.query(
      `
       INSERT INTO "specialties" ("name", "description", "img_url") VALUES
        ('Nội tổng quát', 'Khám và điều trị bệnh nội chung', 'https://cdn-icons-png.flaticon.com/512/3774/3774299.png'),
        ('Nhi khoa', 'Khám và điều trị cho trẻ em', 'https://img.icons8.com/?size=100&id=p2d1FgnXor9x&format=png&color=000000'),
        ('Tai - Mũi - Họng', 'Chuyên điều trị các bệnh tai, mũi, họng', 'https://img.icons8.com/?size=100&id=rTQ4En7AeuQ1&format=png&color=000000'),
        ('Tim mạch', 'Chuyên điều trị các bệnh lý tim', 'https://img.icons8.com/?size=100&id=iUw8YXRVW2S0&format=png&color=000000'),
        ('Da liễu', 'Chuyên điều trị các bệnh da liễu', 'https://img.icons8.com/?size=100&id=MOj6Zjf10vZv&format=png&color=000000'),
        ('Xương khớp', 'Chấn thương chỉnh hình và cơ xương khớp', 'https://img.icons8.com/?size=100&id=sAzBTj4hB0gT&format=png&color=000000'),
        ('Phụ sản', 'Chăm sóc sức khỏe sinh sản và thai kỳ', 'https://img.icons8.com/?size=100&id=Kk8ICotGvcA9&format=png&color=000000'),
        ('Tiêu hóa', 'Khám và điều trị các bệnh tiêu hóa', 'https://img.icons8.com/?size=100&id=EvRCUVdDhhgF&format=png&color=000000'),
        ('Thần kinh', 'Điều trị các bệnh lý thần kinh', 'https://img.icons8.com/?size=100&id=Cuq2YZuRDrbi&format=png&color=000000'),
        ('Mắt', 'Khám và điều trị các vấn đề về mắt', 'https://img.icons8.com/?size=100&id=113879&format=png&color=000000'),
        ('Răng - Hàm - Mặt', 'Khám và điều trị răng miệng và hàm mặt', 'https://img.icons8.com/?size=100&id=64450&format=png&color=000000'),
        ('Ung bướu', 'Chẩn đoán và điều trị ung thư', 'https://img.icons8.com/?size=100&id=LUYKebvCUxz9&format=png&color=000000'),
        ('Hô hấp', 'Khám và điều trị các bệnh lý hô hấp', 'https://img.icons8.com/?size=100&id=Z3a9Q1E2ZCw3&format=png&color=000000'),
        ('Thận - Tiết niệu', 'Chăm sóc hệ tiết niệu và thận', 'https://img.icons8.com/?size=100&id=81090&format=png&color=000000'),
        ('Lão khoa', 'Chăm sóc sức khỏe người cao tuổi', 'https://img.icons8.com/?size=100&id=ysp3HiIhyRdn&format=png&color=000000');
    `,
    );

    //Dữ liệu về admin
    await queryRunner.query(`
      INSERT INTO "users" ("username", "email", "password", "phone", "fullname", "gender", "dateOfBirth", "picture", "address", "isAdmin")
    ...
    for (let i = 0; i < patients.length; i++) {
      ...
      await queryRunner.query(`
        INSERT INTO "users" ("id","username", "email", "password", "phone", "fullname", "gender", "dateOfBirth", "picture", "address", "isAdmin")
    ...
    //Thêm dữ liệu về hồ sơ sức khỏe
    const healthProfiles = [
      {
        weight: 65,
        height: 170,
        blood_type: 'O',
        medical_history: 'Tiểu đường tuýp 2, điều trị ổn định.',
        ...
        vaccinations: 'COVID-19, Viêm gan B',
        smoking: false,
        alcohol_consumption: false,
        exercise_frequency: '3 lần/tuần',
        last_checkup_date: '2024-12-01',
        patient_id: 100,
      },
      {
        weight: 54,
        height: 160,
        blood_type: 'A',
        medical_history: 'Viêm khớp dạng thấp.',
        ...
        vaccinations: 'Cúm mùa, HPV',
        smoking: false,
        alcohol_consumption: true,
        exercise_frequency: '2 lần/tuần',
      ...
      },
      {
        ...
        vaccinations: 'COVID-19, Cúm mùa',
        smoking: true,
        alcohol_consumption: true,
        exercise_frequency: '1 lần/tuần',
      ...
      },
      {
        ...
        medications: 'Không',
        vaccinations: 'COVID-19, Bạch hầu',
        smoking: false,
        alcohol_consumption: false,
        exercise_frequency: '4 lần/tuần',
      ...
      },
      {
        ...
        height: 172,
        blood_type: 'O',
        medical_history: 'Hen suyễn từ nhỏ.',
        allergies: 'Dị ứng bụi nhà.',
        heart_rate: 75,
        blood_pressure: '125/82',
        glucose_level: 105,
        cholesterol_level: 200,
        medications: 'Salbutamol',
        vaccinations: 'Viêm phổi, Cúm mùa',
        smoking: false,
        alcohol_consumption: true,
        exercise_frequency: '2 lần/tuần',
        last_checkup_date: '2025-02-28',
        patient_id: 104,
      },
    ];
    ...
    for (let i = 0; i < doctors.length; i++) {
      ...
      await queryRunner.query(`
        INSERT INTO "doctors" ("experience", "about_me", "workplace", "specialty_id", "user_id")
        VALUES (${experience}, '${about_me}', '${workplace}', ${specialty_id}, '${id}')
      `);
    }
    ...
    for (let i = 0; i < doctors.length; i++) {
      ...
      for (const day of workingDays) {
        for (const slot of workingHours) {
          await queryRunner.query(`
                    INSERT INTO "doctor_schedules" ("day_of_week","start_time","end_time","isActive","doctor_id") VALUES
    ...
    for (let i = 0; i < articles.length; i++) {
      ...
      await queryRunner.query(`
        INSERT INTO "articles" ("title","content","summary","slug","img_url","isApprove","topic_id","author_id") VALUES
        ('${title}','${content}','${summary}','${slug}','${img_url}','${isApprove}',${topic_id},${author_id})
        `);
    }
