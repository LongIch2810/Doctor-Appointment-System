...
export class SeedData1751517995483 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    for (let i = 0; i < articles.length; i++) {
      ...
      await queryRunner.query(`
        INSERT INTO "articles" ("title","content","summary","slug","img_url","is_approve","topic_id","author_id") VALUES
        ('${title}','${content}','${summary}','${slug}','${img_url}','${is_approve}',${topic_id},${author_id})
        `);
    }
