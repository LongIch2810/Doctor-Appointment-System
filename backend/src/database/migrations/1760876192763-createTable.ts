...
export class CreateTable1760876192763 implements MigrationInterface {
    name = 'CreateTable1760876192763'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "channel_members" ("id" SERIAL NOT NULL, "participant_id" integer, "channel_id" integer, CONSTRAINT "PK_95976b619edca48aed364c70c36" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."call_status" AS ENUM('accepted', 'rejected', 'missed')`);
        await queryRunner.query(`CREATE TABLE "messages" ("id" SERIAL NOT NULL, "message_type" "public"."message_type" NOT NULL, "content" character varying, "call_status" "public"."call_status", "call_duration" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "sender_id" integer, "channel_id" integer, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "health_profile" ADD CONSTRAINT "FK_ccd502e69a22e29afcb1c375ec1" FOREIGN KEY ("relative_id") REFERENCES "relatives"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
